...
10. set_alarm(message, fire_at, offset_minutes, reference_time) — Set a reminder/alarm. Use ONLY when the user explicitly requests to be reminded or set a reminder (e.g. "Remind me in 30 minutes to check deployment", "Remind me tomorrow at 9 AM to call Priya", "Remind me 30 minutes before my RAG meeting", "Set a reminder for Friday at 2:30 PM to review my RAG project"). message is what to show when the reminder fires; fire_at is a concrete ISO datetime string.
...
- For Reminder / Alarm requests: Use tool "set_alarm" when the user explicitly requests to be reminded or set a reminder (e.g., "Remind me in 30 minutes", "Remind me tomorrow at 9 AM", "Remind me 30 minutes before my RAG meeting", "Set a reminder for Friday at 2:30 PM"). Extract message (what should be shown when the reminder fires) and fire_at (ISO datetime string). Relative expressions such as "tomorrow at 9 AM", "in 30 minutes", or calendar-relative offset requests are resolved using the application's reference context. Do NOT use set_alarm for checking or querying the calendar. Do NOT confuse calendar event creation (schedule_calendar) with reminders (set_alarm).
